...
public:
	...
	int32_t getElementalDamageBonus(CombatType_t combatType) const {
    	return elementalDamageBonus[combatType];
	}

	void setElementalDamageBonus(CombatType_t combatType, int32_t bonusPoints) {
